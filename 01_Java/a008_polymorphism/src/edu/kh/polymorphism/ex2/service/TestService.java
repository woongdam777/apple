...
public class TestService {
    ...
    public void ex2() {
        ...
        // 1. 인테페이스는 상수형 필드(public static final)만 작성 가능 확인
        // - 인터페이스에 작성했지만 클래스에 작성하는 static필드와 사용법 동일
        ...
        // KH k = new KH(); // 객체 생성 X
        // Cannot instantiate the type KH
    ...
    public void ex3() {
        ...
        Calculator cal = new KJWCalculator();
        ...
        System.out.println("결과 : " + cal.square(a, x));
    }
