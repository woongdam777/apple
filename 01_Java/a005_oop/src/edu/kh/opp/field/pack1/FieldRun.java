...
import edu.kh.opp.field.pack2.FieldTest2;
import edu.kh.opp.field.pack2.FieldTest3;
...
public class FieldRun extends FieldTest3{
	...
	public static void main(String[] args) {
		...
		// FieldTest3은 다른 패키지에 존재
		// -> import가 필요하다!
		FieldTest3 f3 = new FieldTest3();
		
		// 접근제한자 확인
		System.out.println(f1.v1); // public 어디서든지 접근 가능
		System.out.println(f1.v2); // protected 상속관계여서 접근 가능
		System.out.println(f1.v3); // (default) 같은 패키지내여서 접근 가능
	...
	public void ex() {
		...
		// -> FieldTest3의 필드를 FieldRun이 자신의 것처럼 사용가능
