...
public class CreateXMLFile {
	...
	public static void main(String[] args) {
		...
		// XML(eXTensible Markup Language) : 확장된 마크업 언어(기술언어, 기술형식, 모두 String 형식이다.)
		//-> 단순화된 데이터 기술 형식
		
		// XML에 저장되는 데이터의 형식은 Map(Key : Value) 형식이다.
		// -> Key,Value 모두 문자열(String)형식
		// -> Map<String, String> --제네력 형식 표기
		
		// properties (컬렉션)
		// - Map의 후손 클래스
		// -> Key,Value 모두 문자열인 Map<String, String> 타입이 고정이라 제네릭 선언 할 필요가 없다.
		...
		// -> Key,Value 모두 String 고정이라서 제네릭 선언 X
