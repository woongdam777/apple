   ...
   public void boardMenu() {
	      ...
	      do {
	         try {
	            ...
	            // -> 게시글 삽입 서비스 호출(제목, 내용, 로그인한 회원 번호)
	   ...
	   private void selectBoard() {
		   ...
		   // 게시글 상세 조회 서비스 호출
		   	try {
	            ...
	            /* 댓글 메뉴 출력 */
	            commentView.commentMenu(input); // 게시글 번호 
	            ...
	            // 게시글 수정/삭제 기능 노출
	            if(Session.loginMember.getMemberNo() == board.getBoardNo()) {
	            	while(true) {
