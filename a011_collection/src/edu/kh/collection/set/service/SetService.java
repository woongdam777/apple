...
public class SetService {
	...
	public void ex1() {
		...
		// 대표적인 자식 클래스
		// hashSet, LinkedHasthSet, TreeSet
...
//		System.out.println(set.toString());
		...
		// * 코드 설명에 iterator, iteralbe 단어가 포함되어 있다면
		//	반복접근(순차접근)이 가능하다라고 판단 *
		
		// - 컬렉션에서 제공하는 컬렉션 객체의 요소를 반복접근 하는 객체
	...
	public void ex2() {
		...
		// - Hash가 붙은 이유 : 속도 향상
		// --> hashCode() 오버라이딩 필수
		// ---> equals()가 true일 때 hashCod()도 같아야 한다(규칙)
