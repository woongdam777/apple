...
public class StudentView {
	...
	private void selectAll() {
		...
		// service가 참조하는 객체의 필드 중 studentArr를 반환받아
		// 각 배열 요소를 화면에 출력
		...
		for(int i=0 ; i<studentList.length;i++) {
			...
			// NullPinterException
			// -> 참조하고 있는 객체(null)가 없는 참조변수를 이용해서
	...
	private void sumAvgMaxMin() {
		System.out.println("[점수 합계, 평균, 최고점, 최저점 조회]");
