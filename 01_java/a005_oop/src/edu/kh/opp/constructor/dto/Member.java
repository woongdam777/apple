package edu.kh.opp.constructor.dto;
...
public class Member {
	...
	public Member() { // 기본 생성자
		...
		//*****************************************************
		// 클래스 내에 아무런 생성자가 작성되지 않은 경우
		// 컴파일러가 자동으로 기본 생성자를 추가해준다!
		//
		// public Member(){}
		//
		// 단, 기본 생성자만 없고 다른 매개변수 생성자가 존재하면
	...
	// 매개변수 생성자
	// - 객체 생성 시(생성자 호출 시)
	//  ()괄호 안에 객체의 필드를 초기화할 값을 전달 받는 생성자
	public Member(String memberId, String memberPw, String memberName, int memberAge) {
		// Member() 생성자 호출시
		// ()괄호 안에 String, String, String, int 자료형을 작성해라
		
		System.out.println("매개 변수 생성자(String, String, String, int)로 생성");
