...
public class Student {
	...
	public boolean equals(Object obj) {
		...
		Student other = (Student)obj; // obj 다운 캐스팅 - 왜? obj는 직접 자식을 참조할수 없어서...
	 ...
	 // - hashCod() : 객체의 필드 값을 이용해서 일정한 길이의 숫자를 만드는 함수
		
	 // 왜 필요한가? Java 실행시 내부에서 객체 검색하는 속도 증가
	
	 // 어떻게 작성하는가?
	 // 필드 값이 같으면 항상 같은 수가 나올 수 있도록 구현
	 // +equals() 오버라이딩시 필수적으로 같이 오버라이딩한다.
