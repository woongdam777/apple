...
function getBoxText(){
    ...
    // HTML 웹 문서 내에서 id 속성 값이 "test1"인 요소를 얻어와 test1 변수에 대입
...
function getBoxElement(){
    // 문서 내에서 아이디가 test2인 요소를 얻어와 temp변수에 저장
    var temp = document.getElementById("test2");
    
    // temp 요소에 작성된 태그, 속성, 내용을 얻어와 콘소렝 출력
...
//prompt() 함수 확인
function fnPrompt(){
    var input = prompt("이름을 입력해주세요"); /* 확인 == 이름 / 취소 == null */
    var result;
