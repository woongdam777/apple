...
public class MyPageServiceImpl implements MyPageService {
	...
	// 비밀번호 변경 서비스
	// @Transactional // 아무것도 안적을때 UnChecked Exception 발생시 rollback 
	@Transactional(rollbackFor = Exception.class) // 모든 Exception 발생시 rollback 
	@Override
	...
	public int secession(String memberPw, int memberNo) {
		...
		String encPw = mapper.selectEncPw(memberNo);
		// 2. 비밀번호가 일치하면 MEMBER_DEL_FL ->'Y'로 바꾸고 1 반환
