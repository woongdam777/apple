<%-- Book 클래스 import(JSP 표현식 쓸 때 사용, EL은 필요없음!) --%>
...
<body>
    ...
    <ul>
        ...
        <li> \${ paramValues.name속성값[인덱스] } : name이 일치하는 파라미터 배열 중 지정된 인덱스 값 얻어오기 </li>
    </ul>
    ...
    <p>
        ...
        <%-- EL은 import 필요없다 --%>
        book의 title필드(EL 표현식) : ${book.title} <br>
        book의 writer필드(EL 표현식) : ${book.writer} <br>
        book의 price필드(EL 표현식) : ${book.price} <br>
    </p>
    <hr>
    <h1>EL은 null과 비어있다를 같은 것으로 생각한다!</h1>
